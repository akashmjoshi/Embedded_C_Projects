...
/* ---------------------------------------------------------------------------------------------*/
   ...
   P1OUT = 0x00;                           /* Set start up output statuses */
...
/* P2.7                  Digital                  ACK2                Input             */
/* ---------------------------------------------------------------------------------------------*/      
   
   P2SEL = 0x00;                     /* Select IO */
   //P2DIR = 0xF8;                     /* set directions as above */
   P2DIR = 0x78;                     /* set directions as above */
...
/* ---------------------------------------------------------------------------------------------*/           
   ...
   //P3SEL = 0x36;         /* Select as UART and IO */
   P3SEL = 0xF0;         /* Select as UART and IO */
   P3DIR = 0x5F;         /* Set directions based on Pin is input or output */
   //P3DIR = 0xFF;         /* Set directions based on Pin is input or output */
...
/* ---------------------------------------------------------------------------------------------*/   
   ...
   P5SEL = 0x00;                     /* Select IO   */
   P5DIR = 0xFF;                     /* set all pins except P5.1 to outputs */
   P5OUT = 0x01;                     /* set all outputs to 0 */   

   
/* Port pin definition       PORT TYPE               FUNCTION         INPUT|OUTPUT */
/* ---------------------------------------------------------------------------------------------*/
/* P6.0                  Analogue                DEW                        Input             */
/* P6.1                  Analogue                PRESSURE                   Output             */
/* P6.2                  Analogue                TEMPERATURE                Output             */
/* P6.3                  Analogue                Unused                     Output             */                
/* P6.4                  Digital                 BUZZER                     Output            */
/* P6.5                  Digital                 Unused                     Output            */
/* P6.6                  Digital                 Unused                     Output            */
/* P6.7                  Digital                 Unused                     Output            */
/* ---------------------------------------------------------------------------------------------*/      
  
   P6SEL = 0x01;                           /* Select IO and Analog  */
   P6DIR = 0xFE;                           /* set all pins except P6.0 to outputs */
